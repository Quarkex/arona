...
ci.datos_interes, ci.palabras_clave, c.publicado, c.REF_VPORTAL, dsci.TEXTO,
indic_descriptivo.CodigosIndicadores, indic_descriptivo.NombreIndicadores, indic_descriptivo.EtiquetaIndicadores, indic_descriptivo.ValoresIndicadoresLista,
indic_descriptivo.ValoresIndicadores, areasubarea.codareas, areasubarea.areas, areasubarea.codsubareas, areasubarea.subareas,
...
inner join descriptivo dsc on dsc.codcontenido = c.codcontenido
inner join descriptivo_idioma dsci on c.codcontenido = dsci.codcontenido and ci.codidioma = dsci.codidioma
...
group by igc.codcontenido, igc.codidioma) indic_descriptivo on indic_descriptivo.codcontenido = c.codcontenido 
and ci.codidioma= indic_descriptivo.codidioma
