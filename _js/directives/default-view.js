    ...
    '<md-card>',
        ...
        '<md-card-content>',
            ...
            '<div flex="100" ng-if="elements()[0].price != null">',
               ...
               '</md-list-item>',
            '</div>',
            '<div flex="100" ng-if="elements()[0].map_image != null">',
               '<h2 class="md-headline">Mapa</h2>',
                '<md-content class="flex-video" style="background-position: center; background-size: cover; background-image: url(\'{{ elements()[0].map_image }}\');"></md-content>',
            '</div>',
